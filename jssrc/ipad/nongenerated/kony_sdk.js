...
kony.sdk.OfflineObjectService = function(konyRef, serviceName) {
    ...
    this.getBinaryContent = function(options, successCallback, failureCallback) {
        ...
        function getBinaryDataHandler(objMetadata) {
            ...
            if (getBase64 == true) {
                kony.sync.single_binary_select_base64_execute(dbName, objName, binaryColName, pkTable, null, selectSuccessCallback, selectErrorCallback);
            } else {
                kony.sync.single_binary_select_file_execute(dbName, objName, binaryColName, pkTable, null, selectSuccessCallback, selectErrorCallback);
            }
